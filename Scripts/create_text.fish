...
for i in (seq 65 90)
        ...
        msdfgen msdf -font $font $i -noemnormalize -scale 0.07 -autoframe -pxrange 4 -o $output_location/$name.png
        ktx create $output_location/$name.png $output_location/$name.ktx --format R8G8B8A8_SRGB --assign-tf srgb
end